...
export const risk = {
  ...
  imageAlt: "Aksharaa risk & compliance advisor",
  badges: [
    { icon: "shield", label: "Compliance Secured" },
    { icon: "fileText", label: "Risk Assessed" },
    { icon: "trendingUp", label: "Control Enabled" },
  ],
  pillars: [
    { icon: "target", title: "Identify Risk", desc: "Detect compliance gaps early" },
    { icon: "shield", title: "Enable Control", desc: "Implement strong control frameworks" },
    { icon: "monitor", title: "Monitor Systems", desc: "Continuous monitoring with data visibility" },
    { icon: "clipboardCheck", title: "Ensure Compliance", desc: "Sustained compliance and audit readiness" },
  ],
  cta: { label: "Get in Touch", href: "#final-cta" },
  resilience: {
    kicker: "From Risk to Resilience",
    titleA: "We Identify Risks.",
    titleB: "We Build Control.",
    sub: "Every compliance gap exposes your business. We bring clarity, structure, and oversight to keep you always audit-ready.",
  },
  zones: {
    head: "Common Risk Zones",
    tag: "Exposure",
    items: [
      { icon: "calendar", label: "Missed PF / ESI deposit deadlines" },
      { icon: "clipboardCheck", label: "Incomplete statutory registers" },
      { icon: "users", label: "Improper employment documentation" },
      { icon: "mapPin", label: "Multi-state compliance inconsistencies" },
      { icon: "clock", label: "Delayed filings & renewal lapses" },
      { icon: "scan", label: "Regulatory inspection exposure" },
    ],
  },
  mitigation: {
    ...
    tag: "Controlled",
    items: [
      { icon: "calendar", label: "Calendar-driven compliance tracking" },
      { icon: "folderCheck", label: "Structured documentation protocols" },
      { icon: "checkCircle", label: "Pre-submission verification systems" },
      { icon: "users", label: "Dedicated advisory oversight" },
      { icon: "layers", label: "Multi-layer compliance review" },
      { icon: "monitor", label: "Continuous monitoring framework" },
    ],
  },
  benefits: [
    { icon: "trendingUp", title: "Reduced Risk", desc: "Identify and close compliance gaps before they escalate." },
    { icon: "shield", title: "Stronger Control", desc: "Implement structured systems that ensure consistency." },
    { icon: "clipboardCheck", title: "Audit Readiness", desc: "Be inspection-ready with complete documentation." },
    { icon: "users", title: "Business Continuity", desc: "Focus on growth while we manage your compliance." },
  ],
  ctaBar: {
    icon: "calendar",
    title: "Let's build your compliance advantage.",
    sub: "Strengthen governance. Reduce risk. Stay ahead.",
    cta: { label: "Get in Touch", href: "#final-cta" },
  },
