...
import { categoryCta } from "../../../data/compliance-filings-taxation";

export const FilingsCatCta = () => (
  <section id="category-cta" data-testid="filingscat-cta-section" className="bg-ak-ink py-16 md:py-20">
    <Container>
      <Reveal className="flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-shrink-0 flex-wrap items-center gap-4">
          <AkButton href={categoryCta.ctas[0].href} variant="primary" withArrow data-testid="filingscat-cta-primary">
            {categoryCta.ctas[0].label}
          </AkButton>
          <AkButton href={categoryCta.ctas[1].href} variant="darkSecondary" data-testid="filingscat-cta-secondary">
