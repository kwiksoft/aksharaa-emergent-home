...
import { categoryCta } from "../../../data/labour-law";

export const LabourLawCta = () => (
  <section id="category-cta" data-testid="labourlaw-cta-section" className="relative overflow-hidden bg-ak-navy py-24 text-center md:py-32">
    ...
    <Container className="relative z-10">
      <Reveal className="mx-auto max-w-2xl">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          <AkButton href={categoryCta.ctas[0].href} variant="primary" withArrow data-testid="labourlaw-cta-primary">
            {categoryCta.ctas[0].label}
          </AkButton>
          <AkButton href={categoryCta.ctas[1].href} variant="ghost" data-testid="labourlaw-cta-secondary">
