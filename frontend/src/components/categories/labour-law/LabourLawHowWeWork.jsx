...
import { howWeWork } from "../../../data/labour-law";

export const LabourLawHowWeWork = () => (
  <section data-testid="labourlaw-howwework-section" className="bg-ak-ink py-20 md:py-28">
    <Container>
      <Reveal className="max-w-2xl">
        <div className="ak-kicker ak-kicker--light mb-5">{howWeWork.kicker}</div>
        <h2 className="font-display text-3xl font-extrabold leading-[1.04] tracking-tight text-white md:text-4xl">{howWeWork.heading}</h2>
        <p className="mt-5 text-base leading-relaxed text-white/45">{howWeWork.sub}</p>
      </Reveal>
