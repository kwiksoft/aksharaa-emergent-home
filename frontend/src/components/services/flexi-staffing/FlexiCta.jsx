...
/**
 * Flexi Staffing Final CTA — rebuilt to match Payroll Processing's
 * service-cta-section (PayrollCta.jsx) exactly, per direct instruction.
 * Previously this section was a flat ak-orange fill with a single
 * Reveal fade-up and a dark-pill primary button — replaced wholesale
 * with the Payroll template's structure: shared cta-bg.png background
 * image, staggered entrance (kicker -> heading -> sub -> actions rather
 * than one combined fade-up), white pill primary button with a soft
 * breathing glow behind it, and a phone link whose icon badge pulses
 * on hover. testids kept as flexi-* (not payroll-*) since this is the
 * Flexi Staffing page; same data fields otherwise (kicker added to
 * svc-flexi-staffing.js's serviceCta block, which didn't have one
 * before — the new structure needs it where the old one didn't render
 * any kicker line at all).
 */
export const FlexiCta = () => (
  <section
    id="service-cta"
    data-testid="flexi-cta-section"
        ...
        <Reveal delay={0.3} className="flex flex-shrink-0 flex-wrap items-center gap-5">
          <div className="relative">
            ...
            <a
              ...
              data-testid="flexi-final-cta-primary"
