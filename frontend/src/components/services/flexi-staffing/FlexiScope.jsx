...
export const FlexiScope = () => (
  <section id="svc-scope" data-testid="flexi-scope-section" className="bg-ak-mist/40 py-20 md:py-28">
    <Container>
      ...
      <RevealGroup className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3" stagger={0.1}>
        {scope.cards.map((c) => (
          <RevealItem key={c.title} className="rounded-2xl border border-ak-ink/[0.07] bg-white p-6">
