...
/**
 * PF & ESI Returns Filing Final CTA — rebuilt to match Flexi Staffing's
 * service-cta-section (FlexiCta.jsx) exactly, per direct instruction
 * (Section 8 of the post-image-limit handover queue). Previously this
 * section was a flat bg-ak-ink fill with a single combined Reveal
 * fade-up, no kicker line, and an AkButton pill for the primary CTA —
 * replaced wholesale with the Flexi template's structure: shared
 * cta-bg.png background image, staggered entrance (kicker -> heading ->
 * sub -> actions rather than one combined fade-up), white pill primary
 * button with a soft breathing glow behind it, and a phone link whose
 * icon badge pulses on hover. testids kept as returns-* (not flexi-*)
 * since this is the PF & ESI Returns Filing page; serviceCta data block
 * (svc-pf-esi-returns-filing.js) had no kicker field before this — added
 * "Get Started Today" to match Flexi's kicker exactly, since this is
 * literally "copy this section."
 */
export const ReturnsCta = () => (
  <section
    id="service-cta"
    data-testid="returns-cta-section"
        ...
        <Reveal delay={0.3} className="flex flex-shrink-0 flex-wrap items-center gap-5">
          <div className="relative">
            ...
            <a
              ...
              data-testid="returns-final-cta-primary"
