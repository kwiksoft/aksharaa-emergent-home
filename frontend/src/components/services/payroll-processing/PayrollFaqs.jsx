...
export const PayrollFaqs = () => {
  ...
  return (
    <section id="svc-faqs" data-testid="payroll-faqs-section" className="bg-ak-mist/40 py-20 md:py-28">
      <Container>
        ...
        <Reveal delay={0.1} className="mt-10 divide-y divide-ak-ink/[0.08] rounded-2xl border border-ak-ink/[0.07] bg-white">
          {faqs.items.map((f, i) => {
            ...
            return (
              <div key={f.q}>
                <button onClick={() => setOpenIdx(isOpen ? -1 : i)} data-testid={`payroll-faq-${i}`} className="flex w-full items-center justify-between gap-4 px-6 py-5 text-left md:px-7">
