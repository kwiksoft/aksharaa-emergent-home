...
import { serviceCta } from "../../../data/svc-payroll-processing";

/**
 * Final CTA — modeled on PF & ESI Registration's reg-svc-cta-section
 * (same cta-bg.png asset, same white-inverse-button + phone-badge
 * pattern), with payroll-specific aesthetic touches layered on top:
 * staggered entrance (kicker -> heading -> sub -> actions, rather
 * than one single fade-up) and a soft breathing glow behind the
 * primary button so the band doesn't feel static.
 */
export const PayrollCta = () => (
  <section
    id="service-cta"
    data-testid="payroll-cta-section"
        ...
        <Reveal delay={0.3} className="flex flex-shrink-0 flex-wrap items-center gap-5">
          <div className="relative">
            ...
            <a
              ...
              data-testid="payroll-final-cta-primary"
