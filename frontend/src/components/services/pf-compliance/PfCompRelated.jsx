...
import { related } from "../../../data/svc-pf-compliance";

export const PfCompRelated = () => (
  <section id="svc-related" data-testid="pfcomp-related-section" className="bg-ak-mist/40 py-10 md:py-14">
    <Container>
