...
import { serviceCta } from "../../../data/svc-pf-compliance";

export const PfCompCta = () => (
  <section id="service-cta" data-testid="pfcomp-cta-section" className="bg-ak-ink py-16 md:py-20">
    <Container>
      <Reveal className="flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-shrink-0 flex-wrap items-center gap-4">
          <AkButton href={serviceCta.ctas[0].href} variant="primary" withArrow data-testid="pfcomp-final-cta-primary">
